...
import javax.swing.JFrame; // GUI 기반
...
public class DynamicBeat extends JFrame {
	...
	// public static -> 게임 전체에서 통용되는 하나의 변수
	...
	public DynamicBeat() { // 생성자
		...
		// quitButton
		quitButton.setBounds(640, 500, 200, 80);
	...
	public void paint(Graphics g) {
		...
		screenDraw((Graphics2D) screenGraphic); // 글자 깨짐 현상 방지
	...
	public void screenDraw(Graphics2D g) {
		...
		paintComponents(g); // 메인 프레임에 추가된 요소를 보여주는 부분(add)
		try {
			Thread.sleep(5);
		} catch (Exception e) {
	...
	public void gameStart(int nowSelected, String difficulty) {
		...
		game.start();
		setFocusable(true); // 게임을 시작했을 때 키보드에 포커스를 맞춤
	}
